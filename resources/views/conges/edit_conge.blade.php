...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('conges.update', ['conge' => $conges->id]) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="employee_number" name="employee_number"
                                   value="{{ $conges->employee_number }}"  required>
                            </div>
                            <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="date" id="reprise_date" name="reprise_date" class="form-control fc-datepicker" placeholder="YYYY-MM-DD"
                                        type="text" value="{{ $conges->reprise_date }}" required>
                                </div>
    <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" value="{{ $conges->note }}"rows="3"></textarea>
                            </div>
                        </div><br>
