                ...
                <div class="d-flex justify-content-between">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                             <!-- ('Ajout Permission ') -->
                                <a class="btn btn-primary btn-sm" href="{{ route('roles.create') }}">Ajout Role</a>
                                    ...
                                    <td>
                                       <!--('View Permissions ')-->
                                            <a class="btn btn-success btn-sm"
                                                href="{{ route('roles.show', $role->id) }}">View role</a>
                                        ...
                                        @if ($role->name !== 'owner')
                                           <!--('Suppr. Permissions ') -->
                                                ...
                                                {!! Form::submit('Suppr', ['class' => 'btn btn-danger btn-sm']) !!}
                                                {!! Form::close() !!}
